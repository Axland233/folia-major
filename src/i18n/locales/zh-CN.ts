...
export default {
  ...
  "help": {
    ...
    "touchPlayPause": "播放 / 暂停",
    "touchPrevNext": "上一首 / 下一首",
    "touchSeek": "控制播放进度",
    "touchGestureDoubleTap": "双击屏幕",
    "touchGestureSwipe": "← 左右滑动 →",
    "touchGestureHoldDrag": "按住 + 左右拖动",
    "madeBy": "Project:",
    "version": "版本"
  },
  "lyricProvider": {
  ...
  "userGuide": {
    ...
    "touchShortcutsPageTitle": "触屏手势操作",
    "touchShortcutsPageSubtitle": "播放页面可用的触屏手势",
